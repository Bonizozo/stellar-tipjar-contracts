...
fn main() {
    ...
    let _check_functions = || {
        ...
        tipjar_legacy::synthetic::emit_supply_updated(&env, 1, 10000);
        tipjar_legacy::synthetic::emit_collateral_updated(&env, 1, 15000);
        tipjar_legacy::synthetic::emit_synthetic_asset_paused(&env, 1);
        tipjar_legacy::synthetic::emit_synthetic_asset_resumed(&env, 1);
        tipjar_legacy::synthetic::emit_collateralization_updated(&env, 1, 20000);
    };
